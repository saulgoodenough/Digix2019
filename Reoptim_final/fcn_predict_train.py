...
np.save('FCN_prob_6476_train.npy', proba_array_temp)


uid_df = pd.read_csv("../data/age_train.csv", sep=',', header=None)
uid_df.columns = ['id']
...
data_final.to_csv('submission_train.csv', index=False)
