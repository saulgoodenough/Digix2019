...
def get_toy_config():
    ...
    ca_config["estimators"].append(
            {"n_folds": 2, "type": "XGBClassifier", "n_estimators": 20, "max_depth": 5,
             "objective": "multi:softprob", "silent": True, "nthread": -1, "learning_rate": 0.1} )
    ca_config["estimators"].append({"n_folds": 2, "type": "RandomForestClassifier", "n_estimators": 20, "max_depth": None, "n_jobs": 1})
    ca_config["estimators"].append({"n_folds": 2, "type": "ExtraTreesClassifier", "n_estimators": 20, "max_depth": None, "n_jobs": 1})
...
if __name__ == "__main__":
    ...
    X = np.load('train_5000.npy')


    #X = np.load(DATADIR_pro + '/act1hot_train.npy').item()
